    ...
    <section id="turmas" className="bg-[var(--blue-deep)] py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <Reveal>
          <div className="mt-24">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-3xl leading-[1.1] text-white sm:text-4xl lg:text-[42px]">
                Qual é o modelo ideal para você?
              </h2>
              <p className="mt-4 text-base text-white/70">
                A mesma qualidade, adaptada ao seu momento, urgência e idade.
              </p>
            </div>
            ...
            <div className="mt-12 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03]">
              <div className="overflow-x-auto">
                <table className="w-full min-w-[760px] text-left text-sm">
                  <thead>
                    <tr
                      className="text-[var(--blue-deep)]"
                      style={{ background: "color-mix(in oklab, var(--cream) 90%, white)" }}
                    >
                      <Th className="w-[22%]">Característica</Th>
                      <Th>
                        <span className="inline-flex items-center gap-2">
                          <Calendar size={15} style={{ color: "var(--gold)" }} /> Regular (2x/sem)
                        </span>
                      </Th>
                      <Th>
                        <span className="inline-flex items-center gap-2">
                          <Zap size={15} style={{ color: "var(--gold)" }} /> Intensivo
                        </span>
                      </Th>
                      <Th>
                        <span className="inline-flex items-center gap-2">
                          <BookMarked size={15} style={{ color: "var(--gold)" }} /> Reading the West
                        </span>
                      </Th>
                      <Th>
                        <span className="inline-flex items-center gap-2">
                          <Smile size={15} style={{ color: "var(--green)" }} /> Turmas Kids
                        </span>
                      </Th>
                    </tr>
                  </thead>
                  <tbody className="text-white/85">
                    <Row
                      ...
                      cells={["1 hora", "1 hora", "1:30 hora", "1 hora"]}
                      highlight={2}
                    />
                    <Row
                      label="Tempo de Nível"
                      cells={["6 Meses", "3 Meses (50 aulas)", "6 Meses (Ementa)", "Progressão Contínua"]}
                    />
                    <Row
                      label="O Foco"
                      cells={[
                        "Consistência e prática no ritmo ideal",
                        "Imersão rápida e vivência diária",
                        "Argumentação e literatura",
                        "Adaptação lúdica ao idioma",
                      ]}
                    />
                    <Row
                      label="Uso do Livro"
                      cells={[
                        "Alto (até 3 aulas/capítulo)",
                        "Alto (+ aulas extra de debate)",
                        "Textos Clássicos (Não usa material base)",
                        "Moderado / Foco em jogos",
                      ]}
                    />
                    <Row
                      label="Ideal para…"
                      cells={[
                        "Quem procura evolução sólida a longo prazo",
                        "Quem tem urgência (provas/viagens)",
                        "Avançados em busca de fluência cultural",
                        "Crianças que precisam de estímulos dinâmicos",
                      ]}
                      last
                    />
                  </tbody>
